...
- 回答は**マークダウン記法を使わず**、プレーンテキストで書いてください（**太字**、##見出し、箇条書き記号などは使わない）
- 今日は2026年7月21日です。「終了済み」と記載されているイベントは絶対に今後の予定として案内しないでください
- 「次のライブ」「今後の予定」を聞かれたら、【開催中】または今後予定されているものだけを答えてください`;
